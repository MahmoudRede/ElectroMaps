                        ...
                        child: customButton(
                            ...
                            onTap: () {
                              ...
                              AppCubit.get(context)
                                  .addStationToFire(
                                chargingSession:
                                    CashHelper.getData(key: 'chargingSession'),
                                ...
                                parkingPrice:
                                    CashHelper.getData(key: 'parkingPrice'),
                                phoneNumber:
                                    CashHelper.getData(key: 'phoneNumber'),
                                proprietary:
                                    CashHelper.getData(key: 'proprietary'),
                                schedule: CashHelper.getData(key: 'schedule'),
                                typeCurrent:
                                    CashHelper.getData(key: 'typeCurrent'),
                                voltage: CashHelper.getData(key: 'voltage'),
                                where: CashHelper.getData(key: 'where'),
                                stationName:
                                    CashHelper.getData(key: 'stationName'),
                                stationType:
                                    CashHelper.getData(key: 'stationType'),
                                stationStatus:
                                ...
                                connectorType:
                                    CashHelper.getData(key: 'connectorType'),
                                power: CashHelper.getData(key: 'power'),
                                bookingOptions:
                                    CashHelper.getData(key: 'bookingOptions'),
                              )
                                  .then((value) {

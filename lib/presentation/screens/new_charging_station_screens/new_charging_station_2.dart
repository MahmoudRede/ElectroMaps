          ...
          child: Column(
            children: [
              Container(
                ...
                child: Center(child: Text('Charging Station Information(Step 2of6)',style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: ColorManager.textColor),)),
              ),
              SizedBox(height: MediaQuery.sizeOf(context).height * 0.001,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: DefaultTextFormField(controller: placeController, textInputType: TextInputType.text, labelText: 'Where is the charging Station?'),
              ),
                    ...
                    Expanded(
                      child: customButton(borderColor: ColorManager.primaryColor,context: context, title: 'Next',
                          onTap: (){if (formKey.currentState!.validate()) {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) =>const  NewChargingStationScreen3(),));
                                  }
                          }, width: MediaQuery.sizeOf(context).width *0.35, color: ColorManager.primaryColor, textColor: ColorManager.white),
                    ),
                  ],
                ),
              )
